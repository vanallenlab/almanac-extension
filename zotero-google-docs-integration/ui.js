	...
	Zotero.GoogleDocs.UI = {
		...
		activate: async function (force) {
			...
			if (force && !document.hasFocus()) {
				await this.displayAlert("Zotero plugin cannot work without the Google Docs tab and browser window active. " + "Please do not switch away from the window until the operation is complete.", 0, 0);
		...
		render() {
			...
			return React.createElement(
				...
				{ id: 'docs-zotero-menu', className: 'goog-menu goog-menu-vertical docs-menu-hide-mnemonics', role: 'menu',
					style: style },
				React.createElement(Zotero.GoogleDocs.UI.Menu.Item, { label: 'Add/Edit Citation', handleClick: this.props.execCommand.bind(this, 'addEditCitation', null), accel: `${modifiers}+C` }),
				...
				React.createElement(Zotero.GoogleDocs.UI.Menu.Item, { label: 'Preferences', handleClick: this.props.execCommand.bind(this, 'setDocPrefs', null) }),
